 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://uv.enoc.org/", wsdlLocation = "http://localhost:8066/WebApplication2/Service?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://uv.enoc.org/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8066/WebApplication2/Service?wsdl");
    ...
    public org.enoc.uv.Service getServicePort() {
        return super.getPort(new QName("http://uv.enoc.org/", "ServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public org.enoc.uv.Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://uv.enoc.org/", "ServicePort"), Service.class, features);
    }
